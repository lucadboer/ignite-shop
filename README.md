...
Essa aplicação foi desenvolvida através de um desafio da Rocketseat, onde o propósito foi simular um e-commerce de camisetas, com uma comunicação de ponta a ponta até finalizar o pedido do cliente. Foi muito aplicado o conceito de SSG e SSR do Next.js, roteamente das páginas, e utilização da API do stripe para buscar o produto e criar uma nova compra/pedido

This application was developed through a Rocketseat challenge, where the purpose was to simulate an e-commerce t-shirts, with end-to-end communication until the customer's order is completed. The SSG and SSR concept of Next.js was applied a lot, routing the pages, and using the stripe API to fetch the product and create a new purchase/order
...
```
$ git clone https://github.com/lucadboer/ignite-shop.git
```
